...
def fix_indentation(page_name):
    ...
    for i, line in enumerate(lines):
        if widget_marker in line:
            start_line = i
        if 'elementor-element-8e8f95e' in line and start_line != -1:
            end_line = i
            break
    ...
    # 构建正确的表单块和下一个widget块，使用10个tab作为基础缩进
    base = '\t\t\t\t\t\t\t\t\t\t'  # 10 tabs (与第1894行一致)
    level1 = base + '\t'
    level2 = base + '\t\t'
    level3 = base + '\t\t\t'
    level4 = base + '\t\t\t\t'
    ...
    correct_lines = [
        ...
        f'{level1}&lt;/div&gt;\n',
        f'{base}&lt;/div&gt;\n',
        f'{base}&lt;div class="elementor-element elementor-element-d4c499d e-flex e-con-boxed e-con e-parent" data-id="d4c499d" data-element_type="container" data-e-type="container"&gt;\n',
        f'{level1}&lt;div class="e-con-inner"&gt;\n',
        f'{level2}&lt;div class="elementor-element elementor-element-205fe7a elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="205fe7a" data-element_type="widget" data-e-type="widget" data-settings="{{&quot;ultimate_floating_fx_translate_y&quot;:{{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:&quot;&quot;,&quot;sizes&quot;:[]}}}}" data-widget_type="divider.default"&gt;\n',
        f'{level3}&lt;div class="elementor-widget-container"&gt;\n',
        f'{level4}&lt;div class="elementor-divider"&gt;\n',
        f'{level5}&lt;span class="elementor-divider-separator"&gt;\n',
        f'{level5}&lt;/span&gt;\n',
        f'{level4}&lt;/div&gt;\n',
        f'{level3}&lt;/div&gt;\n',
        f'{level2}&lt;/div&gt;\n',
    ...
    # 替换
    new_lines = lines[:start_line] + correct_lines + lines[end_line:]
...
# 处理所有页面
print("Final fix with 10 tabs base indentation...")
fixed_count = 0
