...
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close","a11yCarouselPrevSlideMessage":"Previous slide","a11yCarouselNextSlideMessage":"Next slide","a11yCarouselFirstSlideMessage":"This is the first slide","a11yCarouselLastSlideMessage":"This is the last slide","a11yCarouselPaginationBulletMessage":"Go to slide"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile Portrait","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Landscape","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet Portrait","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Landscape","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}},"hasCustomBreakpoints":false},"version":"4.0.2","is_static":false,"experimentalFeatures":{"e_font_icon_svg":true,"additional_custom_breakpoints":true,"container":true,"nested-elements":true,"global_classes_should_enforce_capabilities":true,"e_variables":true,"e_opt_in_v4_page":true,"e_components":true,"e_interactions":true,"e_widget_creation":true,"import-export-customization":true},"urls":{"assets":"https:\/\/rapidtracerecovery.net\/wp-content\/plugins\/elementor\/assets\/","ajaxurl":"https:\/\/rapidtracerecovery.net\/wp-admin\/admin-ajax.php","uploadUrl":"https:\/\/rapidtracerecovery.net\/wp-content\/uploads"},"nonces":{"floatingButtonsClickTracking":"9deb9fe400","atomicFormsSendForm":"36638df78b"},"swiperClass":"swiper","settings":{"page":[],"editorPreferences":[]},"kit":{"active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description"},"post":{"id":1363,"title":"Rapid%20Trace%20Recovery%20%E2%80%93%20Inteligence%2C%20Investigation%20Company%20","excerpt":"","featuredImage":false}};
...
var Ultimate_Counter_Circle_Widget_Script_Handle=function($scope,$){var circle_progressbar=$scope.find('.ultimate__progress__counter').eq(0);var settings=circle_progressbar.data('settings');var random_id=parseInt(settings.random_id);var figure_display=settings.figure_display;var end_fill=settings.end_fill?parseInt(settings.end_fill):50;var unit_output_text=settings.unit_output_text?settings.unit_output_text:'%';var main_background=settings.main_background;var fill_color=settings.fill_color;var progress_fill_color=settings.progress_fill_color;var progress_width=settings.progress_width?parseInt(settings.progress_width):10;var empty_fill_opacity=settings.empty_fill_opacity?settings.empty_fill_opacity:0.3;var animation_duration=settings.animation_duration?parseInt(settings.animation_duration):2;var active_progressbar=$("#ultimate__progress__counter__"+random_id+"");active_progressbar.svgprogress({figure:figure_display,endFill:end_fill,unitsOutput:"<span class='suffix__unit__text'>"+unit_output_text+"</span>",emptyFill:fill_color,progressFill:progress_fill_color,progressWidth:progress_width,background:main_background,emptyFillOpacity:empty_fill_opacity,animationDuration:animation_duration,});active_progressbar.each(function(){active_progressbar.appear(function(){active_progressbar.trigger('redraw')})})}
...
var Ultimate_Give_Campains_Widget_Script=function(){$('.campaign__progressbar').each(function(){$(this).appear(function(){$(this).find('.count__bar').animate({width:$(this).attr('data-percent')},1000);var percent=$(this).attr('data-percent');$(this).find('.count').html('<span>'+percent+'</span>')})})}
...
var Ultimate_Progressbar_Script=function(){$('.ultimate__progressbar').each(function(){$(this).appear(function(){$(this).find('.count__bar').animate({width:$(this).attr('data-percent')},1000);var percent=$(this).attr('data-percent');$(this).find('.count').html('<span>'+percent+'</span>')})})}
var Ultimate_Masonry_Filter_Script=function($scope,$){var grid_elem=$scope.find('.ultimate-filter-activation').eq(0);var elem_id=grid_elem.attr('id');var grid_activation_id=$('#'+elem_id);var settings=grid_elem.data('settings');if('slider'!=settings.gallery_type||'genaral'!=settings.gallery_type){var gallery_id=settings.gallery_id?settings.gallery_id:1234;var item_selector='.ultimate__grid__item__'+gallery_id;var filter_menu=$('#filter__menu__'+gallery_id+' li');var active_menu_category=settings.active_menu_category?settings.active_menu_category:'';var layout_mode=settings.layout_mode;if('masonry'===layout_mode){var layoutMode='masonry';var layoutOption={columnWidth:item_selector,gutter:0,};var option_cat=layoutMode}else if('fitRows'===layout_mode){var layoutMode='fitRows';var layoutOption={gutter:0,};var option_cat=layoutMode}else if('masonryHorizontal'===layout_mode){var layoutMode='masonryHorizontal';var layoutOption={rowHeight:item_selector,};var option_cat=layoutMode}else if('fitColumns'===layout_mode){var layoutMode='fitColumns'}else if('cellsByColumn'===layout_mode){var layoutMode='cellsByColumn';var layoutOption={columnWidth:item_selector,rowHeight:item_selector,};var option_cat=layoutMode}else{var layoutMode='fitRows';var layoutOption={gutter:0,};var option_cat=layoutMode}
if(active_menu_category!=''){var active_filter='.'+active_menu_category.toLowerCase();filter_menu.removeClass('active');$('.filter__menu li[data-filter="'+active_filter+'"]').addClass('active')}else{var active_filter='*'}
if(elementorFrontend.isEditMode()!=!0){if(typeof imagesLoaded==='function'){imagesLoaded(grid_activation_id,function(){setTimeout(function(){grid_activation_id.isotope({itemSelector:item_selector,resizesContainer:!0,filter:active_filter,layoutMode:layoutMode,option_cat:layoutOption,})},500)})}}
$(window).on('load',function(){if(typeof imagesLoaded==='function'){imagesLoaded(grid_activation_id,function(){setTimeout(function(){grid_activation_id.isotope({itemSelector:item_selector,resizesContainer:!0,filter:active_filter,layoutMode:layoutMode,option_cat:layoutOption,})},500)})}});if(elementorFrontend.isEditMode()===!0){$(window).on('load',function(){filter_menu.on('click',function(event){$(this).siblings('.active').removeClass('active');$(this).addClass('active');event.preventDefault()})})}else{filter_menu.on('click',function(event){$(this).siblings('.active').removeClass('active');$(this).addClass('active');event.preventDefault()})}
if(elementorFrontend.isEditMode()===!0){$(window).on('load',function(){filter_menu.on('click',function(){var filterValue=$(this).attr('data-filter');grid_activation_id.isotope({filter:filterValue,animationOptions:{duration:750,easing:'linear',queue:!1,}});return!1})})}else{filter_menu.on('click',function(){var filterValue=$(this).attr('data-filter');grid_activation_id.isotope({filter:filterValue,animationOptions:{duration:750,easing:'linear',queue:!1,}});return!1})}}}
var Ultimate_Product_Tabs_Filter=function(){$('.tab__menus').on('click',function(e){$('.product__tab__content .tab-pane').removeClass('active in');var $this=$(this);if(!$this.hasClass('active in')){$this.addClass('active in')}
e.preventDefault()})}
var Ultimate_Edd_Search_Widget_Script=function($scope,$){var select_Ids=$('select');$('select').addClass('wide');select_Ids.niceSelect()}
var Ultimate_Tooltip_Modal_Script=function($scope,$){var tooltip_content=$('.ultimate__toltip__modal');if(tooltip_content.length>0){var window_width=$(window).width();if(window_width>767){tooltip_content.tooltipster({animation:'fade',delay:10,contentAsHTML:!0,interactive:!1,maxWidth:400,theme:['tooltipster-noir','noir-customized'],})}}}
var Ultimate_Add_Span_To_First_Word=function($scope,$){$(".post__meta li").html(function(){var text=$(this).text().trim().split(" ");var first=text.shift();return(text.length>0?"<span class='first__word'>"+first+"</span> ":first)+text.join(" ")})}
var Animate_Headline_Script=function($scope,$){var headline_content=$scope.find('.ultimate__animate__heading__activation').eq(0);var settings=headline_content.data('settings');var wrap_id=headline_content.attr('id');var active_wrap=$('#'+wrap_id);var random_id=settings.random_id;var animate_type=settings.animate_type;active_wrap.animatedHeadline({animationType:animate_type,animationDelay:3500,revealDuration:1000,revealAnimationDelay:1500})}
var Scroll_Buttom_Script=function($scope,$){var content=$scope.find('.ultimate__scroll__button').eq(0);var settings=content.data('options');var scroll_type=settings.scroll_type;if('scroll_top'==scroll_type){var bodyAnimate=$('html,body');var scrollToTop=$('.ultimate__scroll__button.scroll_top');scrollToTop.on('click',function(e){bodyAnimate.animate({scrollTop:0},700);return!1})}}
var Ultimate_Flip_Box_Script=function($scope,$){var elem=$scope.find('.element__ready__flipbox__activation').eq(0);var settings=elem.data('options');var random_id=elem.attr('id');var actve_id=settings.actve_id;var flip_axis=settings.flip_axis;var flip_trigger=settings.flip_trigger;var flip_reverse=settings.flip_reverse;var flip_transition=settings.flip_transition;var activatation_id=$('#'+random_id);var inner_wrap_class=activatation_id.find('.flip__box__main__wrap');inner_wrap_class.flip({axis:flip_axis,trigger:flip_trigger,reverse:flip_reverse,speed:flip_transition,front:'.flip__box__front__part',back:'.flip__box__back__part'})}
var Ultimate_Progress_Script=function($scope,$){var element=$scope.find('.ultimate__progressbar__activation').eq(0);var settings=element.data('options');var id=element.attr('id');var activation_id=$('#'+id);var percentage=settings.percentage?settings.percentage:70;var unit=settings.unit?settings.unit:'%';var height=settings.height?settings.height+'px':'10px';var radius=settings.radius?settings.radius+'px':'0px';var ShowProgressCount=settings.ShowProgressCount;var animation=settings.animation;var duration=settings.duration?settings.duration:1000;var fillBackgroundColor=settings.fillBackgroundColor?settings.fillBackgroundColor:'#3498db';var backgroundColor=settings.backgroundColor?settings.backgroundColor:'#EEEEEE';activation_id.appear(function(){var active=$(this);active.easyBar({percentage:percentage,unit:unit,ShowProgressCount:ShowProgressCount,animation:animation,duration:duration,fillBackgroundColor:fillBackgroundColor,backgroundColor:backgroundColor,radius:radius,height:height,width:'100%',})})}
var Ultimate_Image_Compare_Script=function($scope,$){var element=$scope.find('.element__ready__image__compare__wrap').eq(0);var settings=element.data('options');var id=element.attr('id');var activation_id=$('#'+id);var default_offset_pct=settings.default_offset_pct?settings.default_offset_pct:0.5;var orientation=settings.orientation?settings.orientation:'horizontal';var before_label=settings.before_label?settings.before_label:'before';var after_label=settings.after_label?settings.after_label:'after';var no_overlay=settings.no_overlay;var move_slider_on_hover=settings.move_slider_on_hover;var move_with_handle_only=settings.move_with_handle_only;var click_to_move=settings.click_to_move;activation_id.twentytwenty({default_offset_pct:default_offset_pct,orientation:orientation,before_label:before_label,after_label:after_label,no_overlay:no_overlay,move_slider_on_hover:move_slider_on_hover,move_with_handle_only:move_with_handle_only,click_to_move:click_to_move})}
var Global_Element_Ready_Script=function($scope){var UltimateFloatingEffect=elementorModules.frontend.handlers.Base.extend({onInit:function(){elementorModules.frontend.handlers.Base.prototype.onInit.apply(this,arguments);this.widgetContainer=this.$element.find('.elementor-widget-container')[0];this.run()},getTheElement:function(){return this.$element.find('.elementor-widget-container')[0]},resetFx:function(){this.getTheElement()},onDestroy:function(){elementorModules.frontend.handlers.Base.prototype.onDestroy.apply(this,arguments);this.resetFx()},onElementChange:function(){this.resetFx();this.run()},getDefaultSettings:function(){return{targets:this.widgetContainer,loop:!0,direction:'alternate',easing:'easeInOutSine',}},getConfig:function(key){return this.getElementSettings('ultimate_floating_fx_'+key)},run:function(){var settings=this.getElementSettings();var fxSettings=this.getDefaultSettings();console.log(settings);if(settings.ultimate_tilt_effect){if(settings.tilt_maxTilt.size){fxSettings.Tilt={max_tilt:settings.tilt_maxTilt.size||5,}}}
if(settings.ultimate_tilt_effect){this.getTheElement()}},});new UltimateFloatingEffect({$element:$scope})}
$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Adv_Accordion.default',Ultimate_Adv_Accordion_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Animate_Headline.default',Animate_Headline_Script);elementorFrontend.hooks.addAction('frontend/element_ready/UltimateTestmonial.default',Owl_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/UltimateTeams.default',Owl_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Multi_Gallery_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Multi_Gallery_Widget.default',Ultimate_Masonry_Filter_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Instagram_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Post_Carousel.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Post_Carousel.default',Ultimate_Add_Span_To_First_Word);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_WooCommerce_Products_Widget.default',Ultimate_Product_Tabs_Filter);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Portfolio_Carousel.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Portfolio.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Portfolio.default',Ultimate_Masonry_Filter_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Image_Carousel.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Subscriber_Widget.default',MailChimp_Subscribe_Form_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Image_Carousel_Alt.default',Swiper_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Video_Button.default',Video_Popup_Button_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Counter_Circle_Widget.default',Ultimate_Counter_Circle_Widget_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Countdown_Circle_Widget.default',Ultimate_Countdown_Circle_Timer_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Give_Campains_Widget.default',Ultimate_Give_Campains_Widget_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Give_Campains_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Timeline_Widget.default',Timeline_Script_Handle_Data);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Timeline_Roadmap_Widget.default',Timeline_Roadmap_Script_Handle_Data);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Step_Timeline_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Progress_Roadmap_Widget.default',Ultimate_Progressbar_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Progressbar_Widget.default',Ultimate_Progress_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Welcome_Slides_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Welcome_Slides_Widget.default',Slider_Video_Popup_Button_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Welcome_Slides_Widget.default',Ultimate_Slider_Animation_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Edd_Search_Widget.default',Ultimate_Edd_Search_Widget_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Edd_Products_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Edd_Products_Widget.default',Ultimate_Masonry_Filter_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Edd_Products_Widget.default',Ultimate_Tooltip_Modal_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Thumb_Category_Widget.default',Slick_Carousel_Script_Handle);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Scroll_Button.default',Scroll_Buttom_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Tabs_Menu_Widget.default',Ultimate_Tabs_Script);elementorFrontend.hooks.addAction('frontend/element_ready/Ultimate_Price_Tabs_Widget.default',Ultimate_Tabs_Script)})})(jQuery);



var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close","a11yCarouselPrevSlideMessage":"Previous slide","a11yCarouselNextSlideMessage":"Next slide","a11yCarouselFirstSlideMessage":"This is the first slide","a11yCarouselLastSlideMessage":"This is the last slide","a11yCarouselPaginationBulletMessage":"Go to slide"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile Portrait","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Landscape","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet Portrait","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Landscape","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}},"hasCustomBreakpoints":false},"version":"4.0.2","is_static":false,"experimentalFeatures":{"e_font_icon_svg":true,"additional_custom_breakpoints":true,"container":true,"nested-elements":true,"global_classes_should_enforce_capabilities":true,"e_variables":true,"e_opt_in_v4_page":true,"e_components":true,"e_interactions":true,"e_widget_creation":true,"import-export-customization":true},"urls":{"assets":"https:\/\/rapidtracerecovery.net\/wp-content\/plugins\/elementor\/assets\/","ajaxurl":"https:\/\/rapidtracerecovery.net\/wp-admin\/admin-ajax.php","uploadUrl":"https:\/\/rapidtracerecovery.net\/wp-content\/uploads"},"nonces":{"floatingButtonsClickTracking":"9deb9fe400","atomicFormsSendForm":"36638df78b"},"swiperClass":"swiper","settings":{"page":[],"editorPreferences":[]},"kit":{"active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description"},"post":{"id":1363,"title":"Rapid%20Trace%20Recovery%20%E2%80%93%20Inteligence%2C%20Investigation%20Company%20","excerpt":"","featuredImage":false}};
(function($){'use strict';$.ajaxChimp={responses:{'We have sent you a confirmation email':0,'Please enter a value':1,'An email address must contain a single @':2,'The domain portion of the email address is invalid (the portion after the @: )':3,'The username portion of the email address is invalid (the portion before the @: )':4,'This email address looks fake or invalid. Please enter a real email address':5},translations:{'en':null},init:function(selector,options){$(selector).ajaxChimp(options)}};$.fn.ajaxChimp=function(options){$(this).each(function(i,elem){var form=$(elem);var email=form.find('input[type=email]');var label=form.find('label[for='+email.attr('id')+']');var settings=$.extend({'url':form.attr('action'),'language':'en'},options);var url=settings.url.replace('/post?','/post-json?').concat('&c=?');form.attr('novalidate','true');email.attr('name','EMAIL');form.submit(function(){var msg;function successCallback(resp){if(resp.result==='success'){msg='We have sent you a confirmation email';label.removeClass('error').addClass('valid');email.removeClass('error').addClass('valid')}else{email.removeClass('valid').addClass('error');label.removeClass('valid').addClass('error');var index=-1;try{var parts=resp.msg.split(' - ',2);if(parts[1]===undefined){msg=resp.msg}else{var i=parseInt(parts[0],10);if(i.toString()===parts[0]){index=parts[0];msg=parts[1]}else{index=-1;msg=resp.msg}}}catch(e){index=-1;msg=resp.msg}}if(settings.language!=='en'&&$.ajaxChimp.responses[msg]!==undefined&&$.ajaxChimp.translations&&$.ajaxChimp.translations[settings.language]&&$.ajaxChimp.translations[settings.language][$.ajaxChimp.responses[msg]]){msg=$.ajaxChimp.translations[settings.language][$.ajaxChimp.responses[msg]]}label.html(msg);label.show(2000);if(settings.callback){settings.callback(resp)}}var data={};var dataArray=form.serializeArray();$.each(dataArray,function(index,item){data[item.name]=item.value});$.ajax({url:url,data:data,success:successCallback,dataType:'jsonp',error:function(resp,text){console.log('mailchimp ajax submit error: '+text)}});var submitMsg='Submitting...';if(settings.language!=='en'&&$.ajaxChimp.translations&&$.ajaxChimp.translations[settings.language]&&$.ajaxChimp.translations[settings.language].submit){submitMsg=$.ajaxChimp.translations[settings.language].submit}label.html(submitMsg).show(2000);return!1})});return this}})(jQuery);
...
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close","a11yCarouselPrevSlideMessage":"Previous slide","a11yCarouselNextSlideMessage":"Next slide","a11yCarouselFirstSlideMessage":"This is the first slide","a11yCarouselLastSlideMessage":"This is the last slide","a11yCarouselPaginationBulletMessage":"Go to slide"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile Portrait","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Landscape","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet Portrait","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Landscape","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}},"hasCustomBreakpoints":false},"version":"4.0.2","is_static":false,"experimentalFeatures":{"e_font_icon_svg":true,"additional_custom_breakpoints":true,"container":true,"nested-elements":true,"global_classes_should_enforce_capabilities":true,"e_variables":true,"e_opt_in_v4_page":true,"e_components":true,"e_interactions":true,"e_widget_creation":true,"import-export-customization":true},"urls":{"assets":"https:\/\/rapidtracerecovery.net\/wp-content\/plugins\/elementor\/assets\/","ajaxurl":"https:\/\/rapidtracerecovery.net\/wp-admin\/admin-ajax.php","uploadUrl":"https:\/\/rapidtracerecovery.net\/wp-content\/uploads"},"nonces":{"floatingButtonsClickTracking":"9deb9fe400","atomicFormsSendForm":"36638df78b"},"swiperClass":"swiper","settings":{"page":[],"editorPreferences":[]},"kit":{"active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description"},"post":{"id":1363,"title":"Rapid%20Trace%20Recovery%20%E2%80%93%20Inteligence%2C%20Investigation%20Company%20","excerpt":"","featuredImage":false}};
(function($){$(window).on('elementor/frontend/init',function(){var FloatingFx=elementorModules.frontend.handlers.Base.extend({onInit:function(){elementorModules.frontend.handlers.Base.prototype.onInit.apply(this,arguments);this.run()},getTheElement:function(){return this.$element.find('.elementor-widget-container')[0]},resetFx:function(){anime.remove(this.getTheElement());this.getTheElement()&&this.getTheElement().removeAttribute('style')},onDestroy:function(){elementorModules.frontend.handlers.Base.prototype.onDestroy.apply(this,arguments);this.resetFx()},onElementChange:function(){this.resetFx();this.run()},run:function(){var settings=this.getElementSettings(),fxSettings={targets:this.getTheElement(),loop:!0,direction:'alternate',easing:'easeInOutSine'};if(settings.ultimate_floating_fx_translate_toggle){if(settings.ultimate_floating_fx_translate_x.size){fxSettings.translateX={value:settings.ultimate_floating_fx_translate_x.size,duration:settings.ultimate_floating_fx_translate_duration.size,delay:settings.ultimate_floating_fx_translate_delay.size||0}}
if(settings.ultimate_floating_fx_translate_y.size){fxSettings.translateY={value:settings.ultimate_floating_fx_translate_y.size,duration:settings.ultimate_floating_fx_translate_duration.size,delay:settings.ultimate_floating_fx_translate_delay.size||0}}}
if(settings.ultimate_floating_fx_rotate_toggle){if(settings.ultimate_floating_fx_rotate_x.size){fxSettings.rotateX={value:settings.ultimate_floating_fx_rotate_x.size,duration:settings.ultimate_floating_fx_rotate_duration.size,delay:settings.ultimate_floating_fx_rotate_delay.size||0}}
if(settings.ultimate_floating_fx_rotate_y.size){fxSettings.rotateY={value:settings.ultimate_floating_fx_rotate_y.size,duration:settings.ultimate_floating_fx_rotate_duration.size,delay:settings.ultimate_floating_fx_rotate_delay.size||0}}
if(settings.ultimate_floating_fx_rotate_z.size){fxSettings.rotateZ={value:settings.ultimate_floating_fx_rotate_z.size,duration:settings.ultimate_floating_fx_rotate_duration.size,delay:settings.ultimate_floating_fx_rotate_delay.size||0}}}
if(settings.ultimate_floating_fx_scale_toggle){if(settings.ultimate_floating_fx_scale_x.size){fxSettings.scaleX={value:settings.ultimate_floating_fx_scale_x.size,duration:settings.ultimate_floating_fx_scale_duration.size,delay:settings.ultimate_floating_fx_scale_delay.size||0}}
if(settings.ultimate_floating_fx_scale_y.size){fxSettings.scaleY={value:settings.ultimate_floating_fx_scale_y.size,duration:settings.ultimate_floating_fx_scale_duration.size,delay:settings.ultimate_floating_fx_scale_delay.size||0}}}
if(settings.ultimate_floating_fx_translate_toggle||settings.ultimate_floating_fx_rotate_toggle||settings.ultimate_floating_fx_scale_toggle){this.getTheElement()&&this.getTheElement().style.setProperty('will-change','transform');anime(fxSettings)}}});elementorFrontend.hooks.addAction('frontend/element_ready/widget',function($scope){new FloatingFx({$element:$scope})})})}(jQuery));
